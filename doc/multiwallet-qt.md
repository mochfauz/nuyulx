...
In order to support loading of multiple wallets in nuyul-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nuyul.cpp.
...
Changes to nuyul.cpp
----------------------
nuyul.cpp is the entry point into nuyul-qt, and as such, will require some minor modifications to provide hooks for
