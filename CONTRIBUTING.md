Contributing to Nuyul Core
============================

The Nuyul Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Nuyul Core project, and is not to be
confused with overall Nuyul Network Protocol consensus changes.

Whether a pull request is merged into Nuyul Core rests with the project merge
...
Patches that change Nuyul consensus rules are considerably more involved than
...
Where a patch set proposes to change the Nuyul consensus, it must have been
...
The project leader is the release manager for each Nuyul Core release.
