...
RESOURCES += src/qt/nuyul.qrc src/qt/nuyul_locale.qrc

TRANSLATIONS += src/qt/locale/nuyul_bg.ts \
                src/qt/locale/nuyul_de.ts \
                src/qt/locale/nuyul_en.ts \
                src/qt/locale/nuyul_es.ts \
                src/qt/locale/nuyul_fi.ts \
                src/qt/locale/nuyul_fr.ts \
                src/qt/locale/nuyul_it.ts \
                src/qt/locale/nuyul_ja.ts \
                src/qt/locale/nuyul_pl.ts \
                src/qt/locale/nuyul_pt.ts \
                src/qt/locale/nuyul_ru.ts \
                src/qt/locale/nuyul_sk.ts \
                src/qt/locale/nuyul_sv.ts \
                src/qt/locale/nuyul_vi.ts \
                src/qt/locale/nuyul_zh_CN.ts \
                src/qt/locale/nuyul_zh_TW.ts
