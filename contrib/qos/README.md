...
This means one can have an always-on nuyuld instance running, and another local nuyuld/nuyul-qt instance which connects to this node and receives blocks from it.
