...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Nuyul features */
        {"nuyul", "masternode", &masternode, true, true, false},
        {"nuyul", "listmasternodes", &listmasternodes, true, true, false},
        {"nuyul", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nuyul", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nuyul", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nuyul", "masternodedebug", &masternodedebug, true, true, false},
        {"nuyul", "startmasternode", &startmasternode, true, true, false},
        {"nuyul", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nuyul", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nuyul", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nuyul", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nuyul", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nuyul", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nuyul", "mnbudget", &mnbudget, true, true, false},
        {"nuyul", "preparebudget", &preparebudget, true, true, false},
        {"nuyul", "submitbudget", &submitbudget, true, true, false},
        {"nuyul", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nuyul", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nuyul", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nuyul", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nuyul", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nuyul", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nuyul", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nuyul", "checkbudgets", &checkbudgets, true, true, false},
        {"nuyul", "mnsync", &mnsync, true, true, false},
        {"nuyul", "spork", &spork, true, true, false},
        {"nuyul", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"nuyul", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use nuyuld, or the -server option to nuyul-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> nuyul-cli " + methodname + " " + args + "\n";
}
