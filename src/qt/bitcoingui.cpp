                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Nuyul Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Nuyul address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nuyul: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zNYL"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Nuyul Core"), this);
    aboutAction->setStatusTip(tr("Show information about Nuyul Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Nuyul"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Nuyul addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Nuyul addresses"));
    ...
    openAction->setStatusTip(tr("Open a Nuyul: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Nuyul Core help message to get a list with possible Nuyul command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Nuyul Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Nuyul network", "", count));
}
...
{
    QString strTitle = tr("Nuyul Core"); // default title
