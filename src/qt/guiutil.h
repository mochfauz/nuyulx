...
/** Utility functions used by the Nuyul Qt UI.
 */
namespace GUIUtil
{
...
// Render Nuyul addresses in monospace font
...
// Parse "nuyul:" URI into recipient object, return true on successful parsing
