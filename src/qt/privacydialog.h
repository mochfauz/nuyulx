...
public:
    ...
    void setZNuyulControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzNYL_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzNYL_clicked();
    void on_pushButtonZNuyulControl_clicked();
