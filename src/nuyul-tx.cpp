...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Nuyul Core nuyul-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nuyul-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nuyul transaction") + "\n" +
                               "  nuyul-tx [options] -create [commands]   " + _("Create hex-encoded nuyul transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nuyul transaction
