...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Nuyul: 1 day
        nTargetSpacing = 60; //Nuyul: 1 minute
        nMaturity = 120;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Nuyul: 1 day
        nTargetSpacing = 1 * 60;  // Nuyul: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testnet.nuyul.io", "testnet.nuyul.io"));         // Single node address
        vSeeds.push_back(CDNSSeedData("testnet1.nuyul.io", "testnet1.nuyul.io"));       // Single node address
        vSeeds.push_back(CDNSSeedData("testnet2.nuyul.io", "testnet2.nuyul.io"));       // Single node address
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Nuyul: 1 day
        nTargetSpacing = 1 * 60;        // Nuyul: 1 minutes
